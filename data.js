...
const places = [
  ...
  },
  {
    ...
    name: "Masjid Teknik",
    category: "ibadah",
    address: "WCXR+677 Masjid Teknik, Tembalang, Kec. Tembalang, Kota Semarang, Jawa Tengah 50275",
    desc: "",
    lat: -7.05195,
    lng: 110.440667,
    icon: "mosque",
  ...
  },
  {
    ...
    desc: "Fasilitas observasi sekaligus spot swafoto berbentuk bangunan bertingkat menyerupai rumah kaca berwarna merah-putih.",
    lat: -7.053284,
    lng: 110.446801,
    icon: "star",
    color: "#0ea5e9"
  ...
  {
    id: 65,
    name: "Toilet Umum - Rektorat UNDIP",
    category: "toilet",
    address: "Dekat Rektorat UNDIP, Jl. Prof. Soedarto, Tembalang",
    desc: "Toilet umum dengan akses untuk difabel, cuci tangan, dan fasilitas dasar. Tersedia untuk publik kampus.",
    lat: -7.048822,
    lng: 110.438006,
    icon: "restroom",
    color: "#06b6d4"
  ...
  {
    id: 66,
    name: "Toilet Umum - Pusat Kegiatan Mahasiswa (PKM)",
    category: "toilet",
    address: "Pusat Kegiatan Mahasiswa UNDIP, Lantai Dasar, Tembalang",
    desc: "Toilet umum strategis untuk mahasiswa PKM, tersedia ruang bayi dan fasilitas lengkap.",
    lat: -7.050833,
    lng: 110.439444,
    icon: "restroom",
    color: "#06b6d4"
  ...
  {
    id: 67,
    name: "Toilet Umum - Perpustakaan Pusat UNDIP",
    category: "toilet",
    address: "Perpustakaan Pusat UNDIP, Lantai 1, Jl. Prof. Soedarto, Tembalang",
    desc: "Toilet umum di dalam gedung perpustakaan dengan fasilitas cuci tangan dan pengering otomatis.",
    lat: -7.048419,
    lng: 110.437867,
    icon: "restroom",
    color: "#06b6d4"
  ...
  {
    id: 68,
    name: "Toilet Umum - Gedung Olahraga (GOR)",
    category: "toilet",
    address: "GOR UNDIP, Area Pusat Kampus, Tembalang",
    desc: "Toilet dan ruang ganti olahraga dekat GOR dengan fasilitas shower, loker, dan air bersih.",
    lat: -7.050889,
    lng: 110.440333,
    icon: "restroom",
    color: "#06b6d4"
  ...
  {
    id: 69,
    name: "Toilet Umum - Area Kantin Terpadu",
    category: "toilet",
    address: "Kantin Terpadu UNDIP, Dekat Rektorat, Tembalang",
    desc: "Toilet umum di area kantin terpadu, dilengkapi fasilitas cuci tangan dan tempat sampah organik.",
    lat: -7.049111,
    lng: 110.438833,
    icon: "restroom",
    color: "#06b6d4"
  ...
  {
    id: 70,
    name: "Toilet Umum - Fakultas Teknik",
    category: "toilet",
    address: "Gedung Teknik UNDIP, Lantai 1, Jl. Prof. Sudarto, Tembalang",
    desc: "Toilet umum di area Fakultas Teknik dengan fasilitas lengkap dan air bersih.",
    lat: -7.051944,
    lng: 110.438611,
    icon: "restroom",
    color: "#06b6d4"
  ...
  {
    id: 72,
    name: "Toilet Umum - Masjid Diponegoro",
    category: "toilet",
    address: "Masjid Diponegoro, Jl. Prof. Sudarto, Area Pusat Kampus, Tembalang",
    desc: "Toilet dan wudhu untuk umat Islam. Fasilitas bersih dan terawat untuk jamaah.",
    lat: -7.050417,
    lng: 110.439500,
    icon: "restroom",
    color: "#06b6d4"
  ...
  {
    id: 73,
    name: "Toilet Umum - Area Olahraga Timur",
    category: "toilet",
    address: "Stadion Diponegoro, Area Timur Kampus, Tembalang",
    desc: "Toilet umum untuk pengunjung area olahraga dan stadion.",
    lat: -7.051389,
    lng: 110.441111,
    icon: "restroom",
    color: "#06b6d4"
  ...
  // ── OLAHRAGA (JOGING TRACK) ──────────────────────────────
  {
    id: 74,
    name: "Joging Track 1",
    category: "olahraga",
    address: "Area Timur Kampus UNDIP, Jl. Prof. Soedarto, Tembalang",
    desc: "Joging Track 1 terletak di area timur kampus UNDIP. Ideal untuk lari pagi dan pemanasan.",
    lat: -7.055061,
    lng: 110.438925,
    icon: "person-running",
    color: "#f59e0b"
  },
  {
    ...
    name: "Joging Track 2",
    category: "olahraga",
    address: "Area Tengah Kampus UNDIP, Jl. Prof. Soedarto, Tembalang",
    desc: "Joging Track 2 terletak di area tengah kampus UNDIP. Cocok untuk lari santai dan latihan rutin.",
    lat: -7.055125,
    lng: 110.440608,
    icon: "person-running",
    color: "#f59e0b"
  ...
  {
    id: 78,
    name: "ATM BNI - Rektorat UNDIP",
    category: "atm",
    address: "Depan Rektorat Universitas Diponegoro, Jl. Prof. H. Soedarto, S.H., Tembalang, Semarang",
    desc: "ATM Bank BNI yang terletak tepat di depan Rektorat UNDIP, menyediakan layanan 24 jam untuk mahasiswa, dosen, dan staf kampus.",
    lat: -7.048844,
    lng: 110.438090,
    icon: "credit-card",
    color: "#8b5cf6"
  ...
  {
    id: 80,
    name: "ATM Mandiri - Fakultas Teknik UNDIP",
    category: "atm",
    address: "Depan Fakultas Teknik UNDIP, Jl. Prof. Soedarto No.13, Tembalang",
    desc: "ATM Bank Mandiri yang terletak di area depan Fakultas Teknik UNDIP untuk kemudahan transaksi mahasiswa teknik.",
    lat: -7.051900,
    lng: 110.438600,
    icon: "credit-card",
    color: "#8b5cf6"
  ...
  {
    id: 81,
    name: "Bank BNI Cabang Tembalang",
    category: "atm",
    address: "Jl. Prof. Soedarto, Tembalang, dekat Fakultas Hukum UNDIP, Semarang 50275",
    desc: "Kantor cabang Bank BNI Tembalang di dekat kawasan UNDIP, melayani transfer, kredit, dan layanan perbankan nasabah umum.",
    lat: -7.049050,
    lng: 110.438050,
    icon: "credit-card",
    color: "#8b5cf6"
  ...
  {
    id: 82,
    name: "ATM BCA - Gedung ICT UNDIP",
    category: "atm",
    address: "Depan Gedung ICT Universitas Diponegoro, Jl. Prof. Soedarto, Tembalang",
    desc: "ATM Bank BCA yang berada di depan Gedung ICT UNDIP untuk pelayanan transaksi perbankan sehari-hari.",
    lat: -7.048950,
    lng: 110.439900,
    icon: "credit-card",
    color: "#8b5cf6"
  },
  {
    ...
    category: "atm",
    address: "XC2R+VHW, Jl. Prof. Mr. Sunario, Tembalang, Kec. Tembalang, Kota Semarang, Jawa Tengah 50275",
    desc: "ATM Mandiri yang terletak di area Fakultas Ekonomi dan Bisnis UNDIP untuk kemudahan transaksi mahasiswa dan staf.",
    lat: -7.047736,
    lng: 110.441466,
    icon: "credit-card",
    color: "#8b5cf6"
  },
  {
    ...
    category: "atm",
    address: "Jl. Prof. Dr. Sudharto Tembalang No.9 B, Pedalangan, Kec. Banyumanik, Kota Semarang, Jawa Tengah 50275",
    desc: "ATM Mandiri KCP Universitas Diponegoro sebagai layanan perbankan dekat akses kampus dan area asrama.",
    lat: -7.054854,
    lng: 110.432202,
    icon: "credit-card",
    color: "#8b5cf6"
  },
  {
    ...
    category: "atm",
    address: "WCXP+HJX, Tembalang, Kec. Tembalang, Kota Semarang, Jawa Tengah 50275",
    desc: "ATM Mandiri di area Fakultas Ilmu Sosial dan Politik UNDIP untuk akses transaksi perbankan sivitas akademika.",
    lat: -7.051012,
    lng: 110.436620,
    icon: "credit-card",
    color: "#8b5cf6"
  ...
  {
    id: 83,
    name: "Parkir Rektorat UNDIP",
    category: "parkir",
    address: "Depan Rektorat UNDIP, Jl. Prof. Soedarto, Tembalang",
    desc: "Area parkir luas di depan gedung Rektorat untuk mobil dan motor. Tarif: Rp 2.000 motor, Rp 5.000 mobil. Jam: 07:00-16:00.",
    lat: -7.048822,
    lng: 110.438006,
    icon: "square-parking",
    color: "#6b7280"
  ...
  {
    id: 84,
    name: "Parkir Teknik Komputer",
    category: "parkir",
    address: "Gedung Teknik Komputer UNDIP, Jl. Prof. Soedarto, Tembalang",
    desc: "Parkir untuk mahasiswa dan pengunjung Departemen Teknik Komputer di UNDIP.",
    lat: -7.050833,
    lng: 110.439444,
    icon: "square-parking",
    color: "#6b7280"
  },
  {
    ...
    category: "parkir",
    address: "Area Gedung Teknik UNDIP, Jl. Prof. Sudarto No.13, Tembalang",
    desc: "Parkir luas untuk mahasiswa dan pengunjung Fakultas Teknik.",
    lat: -7.051944,
    lng: 110.438611,
    icon: "square-parking",
    color: "#6b7280"
  ...
  {
    id: 86,
    name: "Parkir Pusat Kegiatan Mahasiswa Fakultas Teknik",
    category: "parkir",
    address: "GOR UNDIP, Area Pusat Kampus, Tembalang",
    desc: "Parkir untuk pengunjung Pusat Kegiatan Mahasiswa dan Fakultas Teknik.",
    lat: -7.050889,
    lng: 110.440333,
    icon: "square-parking",
    color: "#6b7280"
  ...
  {
    id: 89,
    name: "Parkir Perpustakaan Pusat",
    category: "parkir",
    address: "Perpustakaan Pusat UNDIP, Area Gedung Widya Puraya, Tembalang",
    desc: "Area parkir untuk pengunjung perpustakaan dan gedung Widya Puraya.",
    lat: -7.048419,
    lng: 110.437867,
    icon: "square-parking",
    color: "#6b7280"
...
const categories = {
  ...
  kantin:    { label: "Kantin",     icon: "utensils",                color: "#f97316" },  toilet:    { label: "Toilet",     icon: "restroom",                color: "#06b6d4" },  atm:       { label: "ATM / Bank", icon: "credit-card",             color: "#8b5cf6" },
